...
function request(load) {
    fetch(`https://pokeapi.co/api/v2/pokemon?limit=4&offset=${load}`)
...
let newLoad = 0
const buttonLoad = document.querySelector('#more_button')
...
document.addEventListener("DOMContentLoaded", request(0))